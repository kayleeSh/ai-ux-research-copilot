    ...
    return (
      <div className="upload-page">
        <div className="loading-overlay">
          ...
          <p style={{ fontWeight: 600, fontSize: '1rem' }}>Analyzing transcript…</p>
          <p style={{ color: '#6b7280', fontSize: '0.875rem' }}>
            AI is extracting insights, themes, and pain points
          </p>
        </div>
      </div>
    );
    ...
    <div className="upload-page">
      ...
      <div style={{ marginTop: '24px', display: 'flex', gap: '12px', alignItems: 'center', flexWrap: 'wrap' }}>
        ...
        <span style={{ fontSize: '0.78rem', color: '#9ca3af' }}>
          Extracts summary, quotes, pain points &amp; themes
        </span>
      </div>
      ...
      <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
        <Link to="/workspace/mock-001" className="btn btn-ghost btn-sm">
